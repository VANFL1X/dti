...
<html lang="en">
  <head>
    ...
    <title>Consumer Protection Division</title>
  ...
  <body class="p-4">
    ...
    <div class="container mt-4 section-shell">
      <div class="section-card section-card--consumer">
        <div class="section-head">
          <span class="section-icon"><i class="bi bi-shield-lock"></i></span>
          <div>
            <h1 class="h3 mb-1">Consumer Protection Division</h1>
            <p class="section-subtitle text-muted">Advisories, complaint channels, and consumer rights information.</p>
          </div>
        </div>
        <div class="section-actions justify-content-center">
          ...
          <?php if ($user && user_has_division($user, 'Consumer Protection Division')): ?>
            <button id="setActivityBtn" class="btn btn-primary section-action-btn ms-2" data-division="Consumer Protection Division"><i class="bi bi-calendar-plus"></i><span>Set Activity</span></button>
          <?php elseif (!$user): ?>
          ...
          <?php endif; ?>
          <button id="showDivisionUsersBtn" class="btn btn-outline-secondary section-action-btn ms-2" data-division="Consumer Protection Division"><i class="bi bi-people"></i><span>Users</span></button>
        </div>
        <div class="mt-3 p-3 rounded" style="background: var(--card-bg); border: 1px solid var(--surface-contrast);">
          <div id="divisionCalendar" data-division="Consumer Protection Division"></div>
        </div>
      </div>
    </div>
