...
<html lang="en">
  ...
  <body class="p-4">
    ...
    <div class="container mt-4 section-shell">
      <div class="section-card section-card--planning">
        <div class="section-head">
          <span class="section-icon"><i class="bi bi-diagram-3"></i></span>
          <div>
            <h1 class="h3 mb-1">Planning Unit</h1>
            <p class="section-subtitle text-muted">Planning, reports, and performance monitoring.</p>
          </div>
        </div>
        <div class="section-actions justify-content-center">
          ...
          <?php if ($user && user_has_division($user, 'Planning Unit')): ?>
            <button id="setActivityBtn" class="btn btn-primary section-action-btn ms-2" data-division="Planning Unit"><i class="bi bi-calendar-plus"></i><span>Set Activity</span></button>
          <?php elseif (!$user): ?>
          ...
          <?php endif; ?>
          <button id="showDivisionUsersBtn" class="btn btn-outline-secondary section-action-btn ms-2" data-division="Planning Unit"><i class="bi bi-people"></i><span>Users</span></button>
        </div>
        <div class="mt-3 p-3 rounded" style="background: var(--card-bg); border: 1px solid var(--surface-contrast);">
          <div id="divisionCalendar" data-division="Planning Unit"></div>
        </div>
      </div>
    </div>
